...
import { Calculator, Share2, Download, Trophy, Scale, Ruler, Activity, Dumbbell, UserRound } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-950 p-4 sm:p-8">
      ...
      <main className="max-w-6xl mx-auto space-y-6 app-shell">
        ...
        <Card className="rounded-3xl shadow-md border-slate-200 x-card">
          <CardContent className="p-5 sm:p-7 space-y-4">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Button variant="outline" className="rounded-2xl text-base font-bold h-12" onClick={() => alert("次の段階で画像保存機能を付けるぞ") }>
